...
const Staking3 = initStaking({
  ...
  expiration_time: "2 October 2021",
});
...
const StakingWbtc3 = initStaking({
  token: window.token_wbtc_3,
  staking: window.staking_wbtc_3,
  liquidity: wbtc_address,
  lp_symbol: "DYP/BNB",
  reward: "30,000",
  lock: "3 Days",
  rebase_factor: rebase_factors[4],
  expiration_time: "2 October 2021",
});
const StakingWbtc30 = initStaking({
  token: window.token_wbtc_30,
  staking: window.staking_wbtc_30,
  liquidity: wbtc_address,
  lp_symbol: "DYP/BNB",
  reward: "45,000",
  lock: "30 Days",
  rebase_factor: rebase_factors[5],
  expiration_time: "2 October 2021",
});
const StakingWbtc60 = initStaking({
  token: window.token_wbtc_60,
  staking: window.staking_wbtc_60,
  liquidity: wbtc_address,
  lp_symbol: "DYP/BNB",
  reward: "75,000",
  lock: "60 Days",
  rebase_factor: rebase_factors[6],
  expiration_time: "2 October 2021",
});
const StakingWbtc90 = initStaking({
  token: window.token_wbtc_90,
  staking: window.staking_wbtc_90,
  liquidity: wbtc_address,
  lp_symbol: "DYP/BNB",
  reward: "100,000",
  lock: "90 Days",
  rebase_factor: rebase_factors[7],
  expiration_time: "2 October 2021",
});

const StakingUsdc3 = initStaking({
  token: window.token_usdc_3,
  staking: window.staking_usdc_3,
  liquidity: usdc_address,
  lp_symbol: "DYP/BUSD",
  reward: "30,000",
  lock: "3 Days",
  rebase_factor: rebase_factors[8],
  expiration_time: "2 October 2021",
});
const StakingUsdc30 = initStaking({
  token: window.token_usdc_30,
  staking: window.staking_usdc_30,
  liquidity: usdc_address,
  lp_symbol: "DYP/BUSD",
  reward: "45,000",
  lock: "30 Days",
  rebase_factor: rebase_factors[9],
  expiration_time: "2 October 2021",
});
const StakingUsdc60 = initStaking({
  token: window.token_usdc_60,
  staking: window.staking_usdc_60,
  liquidity: usdc_address,
  lp_symbol: "DYP/BUSD",
  reward: "75,000",
  lock: "60 Days",
  rebase_factor: rebase_factors[10],
  expiration_time: "2 October 2021",
});
const StakingUsdc90 = initStaking({
  token: window.token_usdc_90,
  staking: window.staking_usdc_90,
  liquidity: usdc_address,
  lp_symbol: "DYP/BUSD",
  reward: "100,000",
  lock: "90 Days",
  rebase_factor: rebase_factors[11],
  expiration_time: "2 October 2021",
});
...
const Vesting = initVesting({
  staking: window.constant_stakingvesting_30,
  buyers: true,
  apr: 0,
  liquidity: eth_address,
  expiration_time: "16 February 2022",
});
...
//Buyback New
const BuybackStaking1 = initBuybackStakingNewFront({
...
const BuybackStaking2 = initBuybackStakingNewFront({
...
const BuybackStaking2_front = initBuybackStakingNewFront({
  staking: window.buyback_staking1_2,
  constant: window.constant_staking_new4,
  apr: 100,
  expiration_time: "17 November 2022",
...
//Farming New
const StakingNew1 = initStakingNew_front({
...
const StakingNew2 = initStakingNew_front({
  token: window.token_new,
...
const StakingNew3 = initStakingNew_front({
  token: window.token_new,
...
const StakingNew4 = initStakingNew_front({
  token: window.token_new,
...
const StakingNew5 = initStakingNew_front({
  token: window.token_new,
...
const StakingNew5_front = initStakingNew_front({
  token: window.token_new,
  staking: window.farming_new_5,
  constant: window.constant_staking_new9,
  liquidity: wbnb_address,
...
//Farming New Error
const StakingNewError1 = initStakingNew({
  token: window.token_new,
  staking: window.farming_error_1,
  constant: window.constant_staking_new5,
  liquidity: wbnb_address,
  lp_symbol: "USD",
  reward: "30,000",
...
const StakingNewError2 = initStakingNew({
  token: window.token_new,
  staking: window.farming_error_2,
  constant: window.constant_staking_new6,
  liquidity: wbnb_address,
  lp_symbol: "USD",
  reward: "30,000",
...
const StakingNewError3 = initStakingNew({
  token: window.token_new,
  staking: window.farming_error_3,
  constant: window.constant_staking_new7,
  liquidity: wbnb_address,
  lp_symbol: "USD",
  reward: "30,000",
...
const StakingNewError4 = initStakingNew({
  token: window.token_new,
  staking: window.farming_error_4,
  constant: window.constant_staking_new8,
  liquidity: wbnb_address,
  lp_symbol: "USD",
  reward: "30,000",
...
const StakingNewError5 = initStakingNew({
  token: window.token_new,
  staking: window.farming_error_5,
  constant: window.constant_staking_new9,
  liquidity: wbnb_address,
  lp_symbol: "USD",
  reward: "30,000",
    ...
    return (
      <div className="App App-header" style={{ overflowX: "hidden" }}>
        ...
        <div style={{ minHeight: "550px" }} className="App-container">
                ...
                <div className="sc-lhVmIH xuOEC">
                  ...
                  <div className="sc-btzYZH cRGnnt">
                    <div className="sc-elJkPf kIebhI">
                      ...
                      <button
                        onClick={this.handleConnectionWalletConnect}
          ...
          <Route
            exact
            path="/staking-buyback-new-2"
            render={(props) => (
              <BuybackStaking2_front
                is_wallet_connected={this.state.is_wallet_connected}
                handleConnection={this.handleConnection}
                handleConnectionWalletConnect={
                  this.handleConnectionWalletConnect
