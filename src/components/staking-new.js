                                                ...
                                                <form onSubmit={this.handleWithdraw}>
                                                    <div className='form-group'>
                                                        ...
                                                        <div className='row ' style={{paddingBottom: '20px'}}>
                                                            <div className="col-6">
                                                                <input value={Number(this.state.withdrawAmount) > 0 ? `${this.state.withdrawAmount*LP_AMPLIFY_FACTOR} iDYP/WBNB` : `${this.state.withdrawAmount} iDYP/WBNB`} onChange={e => this.setState({withdrawAmount: Number(e.target.value) > 0 ? e.target.value/LP_AMPLIFY_FACTOR : e.target.value})} className='form-control left-radius' placeholder='0' type='text' disabled />
                                                                {/*<div className='input-group-append'>*/}
