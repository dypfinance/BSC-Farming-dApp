        ...
        refreshBalance = async () => {
            ...
            try {
                ...
                let [token_balance,reward_token_balance, pendingDivs, totalEarnedTokens, stakingTime,
                    ...
                    totalEarnedEth, pendingDivsEth, tvlConstantiDYP, tvlConstantDYP, tvliDYP, depositedTokensDYP, pendingDivsStaking, tvlDYPS
                ] = await Promise.all([_bal, _rBal, _pDivs, _tEarned, _stakingTime, _dTokens, _lClaimTime, _tvl,
                    _tEarnedEth, _pDivsEth, _tvlConstantiDYP, _tvlConstantDYP, _tvliDYP, _dTokensDYP, _pendingDivsStaking, _tvlDYPS])
                                                    ...
                                                    <div className='form-group'>
                                                        ...
                                                        <div className='form-row mb-3'>
                                                            <div className='col-6'>
                                                                ...
                                                                <input value={Number(pendingDivsEth) > 0 ? `${pendingDivsEth} WBNB` : `${pendingDivsEth} WBNB`} onChange={e => this.setState({pendingDivsEth: Number(e.target.value) > 0 ? e.target.value : e.target.value})} className='form-control left-radius' placeholder='0' type='text' disabled />
                                                            </div>
                                                            <div className='col-6'>
                                    ...
                                    <div className='l-box pl-3 pr-3'>
                                        <div className='table-responsive container'>
                                            ...
                                            <table className='table-stats table table-sm table-borderless'>
                                                ...
                                                {/*<tr>*/}
                                                {/*    <th>My LP Balance</th>*/}
                                                {/*    <td className="text-right"><strong>{token_balance}</strong> <small>iDYP/WBNB</small></td>*/}
                                                {/*</tr>*/}
                                                <tr>
                                                ...
                                                <tr>
                                                    <th>MY LP Deposit</th>
                                                    <td className="text-right"><strong>{myDepositedLpTokens}</strong> <small>iDYP/WBNB</small></td>
                                                </tr>
                                                <tr>
                                                    <th>Total LP Deposited</th>
                                                    <td className="text-right"><strong>{tvl}</strong> <small>iDYP/WBNB</small></td>
                                                </tr>
                                                <tr>
