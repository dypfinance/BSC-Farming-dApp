...
export default function initStaking({ staking, apr, liquidity='ETH', lock, expiration_time, other_info }) {
    ...
    class Staking extends React.Component {
        ...
        handleReinvest = async (e) => {
            ...
            if (this.state.stakingTime != 0 && (Date.now() - this.state.stakingTime >= this.state.cliffTime)) {
                window.$.alert('Contract Expired! Your lock time ended so please withdraw your funds and move ' +
                                                    ...
                                                    <div className='form-group'>
                                                        ...
                                                        <p className='form-control  text-right' style={{ border: 'none', marginBottom: 0, paddingLeft: 0, background: 'transparent', color: '#222' }}><span style={{ fontSize: '1.2rem', color: 'rgb(255, 0, 122)' }}>{pendingDivsEth}</span> <small className='text-bold'>WETH</small></p>
                                                            ...
                                                            <div className='col-md-12'>
                                                                ...
                                                                <input value={Number(pendingDivs) > 0 ? `${pendingDivs} WBNB` : `${pendingDivs} WBNB`} onChange={e => this.setState({pendingDivs: Number(e.target.value) > 0 ? e.target.value : e.target.value})} className='form-control left-radius' placeholder='0' type='text' disabled />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className='form-row'>
                                        ...
                                        <div className='col-12'>
                                            <div className='l-box'>
                                                <form onSubmit={(e) => e.preventDefault()}>
                                                    ...
                                                    <p>
                                                        Approx. {getFormattedNumber(this.getApproxReturn(), 6)} WBNB
                                                    </p>
