...
const VaultCard = ({logo, link, name, logo1, logo2, logo3, apys}) => (
    <NavLink to={link}>
            ...
            <div className="">
                ...
                <div className='container'>
                    ...
                    <div className='vaults-list'>
                        {vaults.filter(v => !v.hidden).map((props,i) => <VaultCard {...props} apys={this.state.maxApyBusd} key={i} />)}
                    </div>
                </div>
            </div>
        )
